...
public class TestSteps {
	...
	public void i_make_a_flight_search_from_to_for_one_adult_days_after_today(String departureAirport, String destinationAirport, int daysOffset) throws Throwable {
	...
	public void i_select_first_available_flight_with_standard_fare() throws Throwable {
	...
	public void i_login_to_Ryanair_site_using_username_and_password(String username, String password) throws Throwable {
	...
	public void i_enter_payment_details_with_card_number_expiration_month_expiration_year_and_security_code(String cardNumber, String expiryMonth, String expiryYear, String securityCode) throws Throwable {
		String title = "Mr";
	...
	public void i_complete_payment() throws Throwable {
		paymentPage.acceptTermsAndConiditions();
        paymentPage.clickPayNowButton();
	}

	@Then("^I get payment declined message$")
	public void i_get_payment_declined_message() throws Throwable {
